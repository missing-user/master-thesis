...
## Overview
- `plots/` most simple scripts to generate the plots for my thesis can be found here. More complex plotting was sometimes written as part of the main scripts of the respective tasks instead.
...
Similar results can be obtained by running `qfb_optimization/spec_fb_opt.py`.
